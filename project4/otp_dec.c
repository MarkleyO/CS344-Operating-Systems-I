...
void receiveDecrypted(int estConnect);
...
int main(int argc, char *argv[]){
	...
	char buffer[256], *ptBuffer, *keyBuffer;
	...
	readInFiles(argv[1], argv[2], plaintextFP, keyFP);//checks to see if files are valid
	...
	buffer[0] = '1';//a 1 value is sent for handshake on dec
	...
	plaintextFP = fopen(argv[1], "r");//opens file for cipher
	...
	send(socketFD, "I WANNA STRING", 14, 0);//sends request for decrypted data to server
	receiveDecrypted(socketFD);//receives the decrypted string
	//////////////////////////////////RECEIVE DECRYPTED FILE//////////////////////////////////////////////////////////////////////////
...
//Checks to see if files input are valid for the program
...
//receives decryted file from the server
void receiveDecrypted(int estConnect){
	char buffer[257];
	
	//////////////////////////////////RECEIVING DECRYPTED STRING//////////////////////////////////////////////////////////////////////
	do{
